/*
 * My web font loading approach
 * Based on work by https: //www.zachleat.com/
 * Technically, this is a 2 stage FOUT/FOFT approach
 * 
 * Font Face Observer is the engine. 
 * 
 * CUSTOMIZE YOUR FONTS!
 * Stage 1 Should be 1, MAYBE 2 fonts - regular weight
 * THEN load other weights, italic, etc.
 * 
 * These customization happen at the //CUSTOMIZE HERE comments
 * 
 * These also need to be reflected in TYPOGRAPHY.SCSS
 * 
 * 
 * 
 */ 
